...
wandb.init(
    ...
    project="trainmodel_16384_10k_cont",
...
# train_dataset = load_n_light_curves(16384 * 4, fits_files, band = "med")
train_dataset = load_n_light_curves(16384*2, fits_files, band = "med")
...
model_str = 'trainmodel_16384_10k_cont_real'
model.load_state_dict(torch.load('./models/' + model_str + '.h5'))
optimizer = torch.optim.Adam(model.parameters(), lr=1e-5)
new_model_str = "trainmodel_16384_10k_cont_large"
