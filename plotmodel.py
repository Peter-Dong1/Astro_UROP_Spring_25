...
model_str = 'models/RNN_VAE_cont'
model.load_state_dict(torch.load('./' + model_str + '.h5'))
# model.load_state_dict(torch.load('./RNN_VAE_Err_100Epoch.h5'))
...
test_loader = DataLoader(light_curves_sample, batch_size=32, collate_fn=collate_fn)
model.eval()
